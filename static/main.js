...
var $author$project$Server$Drew = function (a) {
	return {$: 1, a: a};
};
var $author$project$Server$Dropped = function (a) {
	return {$: 0, a: a};
};
var $author$project$Server$Hands = function (a) {
	return {$: 7, a: a};
};
var $author$project$Server$Lobbies = function (a) {
	return {$: 8, a: a};
};
var $author$project$Server$NoCreate = {$: 9};
var $author$project$Server$Player = function (a) {
	return {$: 0, a: a};
};
var $author$project$Server$Rcv = function (a) {
	return {$: 4, a: a};
};
var $author$project$Server$Reset = function (a) {
	return {$: 2, a: a};
};
var $author$project$Server$SmallKong = function (a) {
	return {$: 6, a: a};
};
...
var $author$project$Combo$Double = function (a) {
	return {$: 1, a: a};
};
var $author$project$Combo$Quad = function (a) {
	return {$: 3, a: a};
};
var $author$project$Combo$Triple = function (a) {
	return {$: 2, a: a};
};
var $author$project$KeySet$KeySet = F3(
	function (a, b, c) {
...
var $author$project$KeySet$insert = F2(
	function (val, _v0) {
		var keygen = _v0.a;
		var invkey = _v0.b;
		var s = _v0.c;
		var key = keygen(val);
		return A3(
			$author$project$KeySet$KeySet,
			keygen,
			invkey,
			A2($elm$core$Set$insert, key, s));
	});
...
var $author$project$Combo$Chain = function (a) {
	return {$: 0, a: a};
};
var $author$project$Tile$Numeric = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $elm$core$Set$empty = $elm$core$Dict$empty;
var $author$project$KeySet$empty = F2(
	function (keygen, invkey) {
		return A3($author$project$KeySet$KeySet, keygen, invkey, $elm$core$Set$empty);
	});
var $author$project$Tile$Bamboo = 1;
var $author$project$Tile$Circle = 2;
var $author$project$Tile$D = function (a) {
	return {$: 1, a: a};
};
var $author$project$Tile$Number = 0;
var $author$project$Tile$Single = function (a) {
	return {$: 1, a: a};
};
var $author$project$Tile$W = function (a) {
	return {$: 0, a: a};
};
var $author$project$Tile$Green = 1;
var $author$project$Tile$Red = 0;
var $author$project$Tile$White = 2;
var $author$project$Tile$dragonConvert = function (x) {
	return (!x) ? 0 : ((x === 1) ? 1 : 2);
};
var $author$project$Tile$keyDragon = function (x) {
	return $author$project$Tile$dragonConvert(x - 1);
};
var $author$project$Tile$East = 0;
var $author$project$Tile$North = 3;
var $author$project$Tile$South = 1;
var $author$project$Tile$West = 2;
var $author$project$Tile$windConvert = function (x) {
	return (!x) ? 0 : ((x === 1) ? 1 : ((x === 2) ? 2 : 3));
};
var $author$project$Tile$keyWind = function (x) {
	return $author$project$Tile$windConvert(x - 1);
};
var $author$project$Tile$keyTile = function (key) {
	return (key <= 9) ? A2($author$project$Tile$Numeric, 0, key) : ((key <= 18) ? A2($author$project$Tile$Numeric, 2, key - 9) : ((key <= 27) ? A2($author$project$Tile$Numeric, 1, key - 18) : ((key <= 31) ? $author$project$Tile$Single(
		$author$project$Tile$W(
			$author$project$Tile$keyWind(key - 27))) : $author$project$Tile$Single(
		$author$project$Tile$D(
			$author$project$Tile$keyDragon(key - 31))))));
};
var $author$project$Tile$dragonKey = function (dragon) {
	switch (dragon) {
		case 0:
			return 1;
		case 1:
...
var $author$project$Tile$windKey = function (wind) {
	switch (wind) {
		case 0:
			return 1;
		case 1:
...
var $author$project$Tile$tileKey = function (tile) {
	if (!tile.$) {
		switch (tile.a) {
			case 0:
				var _v1 = tile.a;
		...
		if (!tile.a.$) {
			var wind = tile.a.a;
			return 27 + $author$project$Tile$windKey(wind);
		} else {
			var drag = tile.a.a;
			return 31 + $author$project$Tile$dragonKey(drag);
		}
	}
};
var $author$project$Tile$emptyTileSet = A2($author$project$KeySet$empty, $author$project$Tile$tileKey, $author$project$Tile$keyTile);
...
var $author$project$KeySet$singleton = F3(
	function (val, keygen, invkey) {
		var key = keygen(val);
		return A3(
			$author$project$KeySet$KeySet,
			keygen,
			invkey,
			$elm$core$Set$singleton(key));
	});
var $author$project$Tile$singletonTileSet = function (tile) {
	return A3($author$project$KeySet$singleton, tile, $author$project$Tile$tileKey, $author$project$Tile$keyTile);
};
...
var $author$project$KeySet$toList = function (_v0) {
	var invkey = _v0.b;
	var s = _v0.c;
	var keys = $elm$core$Set$toList(s);
	return A2($elm$core$List$map, invkey, keys);
};
var $author$project$Chain$chiTiles = F2(
	function (ts, c) {
		var tiles = $author$project$KeySet$toList(ts);
		var _v0 = c;
		var cat = _v0.a;
		var x = _v0.b;
		var nums = $elm$core$Set$fromList(
			A2($elm$core$List$range, x, x + 2));
		var reduced_nums = A3(
			$elm$core$List$foldl,
			F2(
				function (t, s) {
					if (!t.$) {
						var y = t.b;
						return A2($elm$core$Set$remove, y, s);
					} else {
			...
			nums,
			tiles);
		var single = $elm$core$List$head(
			$elm$core$Set$toList(reduced_nums));
		var size = $elm$core$Set$size(reduced_nums);
		if (single.$ === 1) {
			return ts;
		} else {
			var y = single.a;
			return (size === 1) ? $author$project$Tile$singletonTileSet(
				A2($author$project$Tile$Numeric, cat, y)) : $author$project$Tile$emptyTileSet;
		}
	});
...
var $author$project$KeySet$diff = F2(
	function (_v0, _v1) {
		var keygen = _v0.a;
		var invkey = _v0.b;
		var s1 = _v0.c;
		...
		return A3(
			...
			keygen,
			invkey,
			A2($elm$core$Set$diff, s1, s2));
	});
var $author$project$KeyCounts$Count = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var $author$project$KeyCounts$get = F2(
	function (val, _v0) {
		...
		var d = _v0.c;
		var key = keygen(val);
		var _v1 = A2($elm$core$Dict$get, key, d);
		if (_v1.$ === 1) {
			return 0;
		} else {
			var x = _v1.a;
...
var $author$project$KeyCounts$increment = function (maybe) {
	if (maybe.$ === 1) {
...
var $author$project$KeyCounts$insert = F2(
	function (val, counts) {
		var prevVal = A2($author$project$KeyCounts$get, val, counts);
		...
		var key = keygen(val);
		var newCounts = A3(
			$author$project$KeyCounts$Count,
			keygen,
			invkey,
...
var $author$project$Updates$chiAdd = F5(
	function (c, prev, _new, canChi, potential) {
		var prevChi = A2($author$project$Chain$chiTiles, prev, c);
		var prevSize = $author$project$KeySet$size(prevChi);
		var newChi = A2($author$project$Chain$chiTiles, _new, c);
		var newSize = $author$project$KeySet$size(newChi);
		var newPotential = ((newSize === 3) && (prevSize < 3)) ? A2(
			$author$project$KeySet$insert,
			$author$project$Combo$Chain(c),
			potential) : potential;
		var diff = A2($author$project$KeySet$diff, newChi, prevChi);
		var tiles = $author$project$KeySet$toList(diff);
		return _Utils_Tuple2(
			A3(
				$elm$core$List$foldl,
				F2(
...
var $author$project$ChainMap$Map = $elm$core$Basics$identity;
var $author$project$ChainMap$addTileChain = F2(
	function (tile, maybe) {
		if (maybe.$ === 1) {
			return $elm$core$Maybe$Just(
				$author$project$Tile$singletonTileSet(tile));
		} else {
			var ts = maybe.a;
			return $elm$core$Maybe$Just(
				A2($author$project$KeySet$insert, tile, ts));
		}
	});
var $author$project$Chain$chainKey = function (chain) {
	switch (chain.a) {
		case 0:
			var _v1 = chain.a;
			var x = chain.b;
...
var $author$project$ChainMap$get = F2(
	function (c, _v0) {
		var d = _v0;
		var key = $author$project$Chain$chainKey(c);
		var _v1 = A2($elm$core$Dict$get, key, d);
		if (_v1.$ === 1) {
			return $author$project$Tile$emptyTileSet;
		} else {
			var ts = _v1.a;
			return ts;
		}
	});
var $author$project$ChainMap$insert = F3(
	function (t, c, map) {
		var prev_ts = A2($author$project$ChainMap$get, c, map);
		var new_ts = A2($author$project$KeySet$insert, t, prev_ts);
		var key = $author$project$Chain$chainKey(c);
		var _v0 = map;
		var d = _v0;
		var new_map = A3(
...
var $author$project$Chain$potentialChains = function (tile) {
	if (!tile.$) {
		var cat = tile.a;
		var x = tile.b;
		var minStart = A2($elm$core$Basics$max, 1, x - 2);
		var maxStart = A2($elm$core$Basics$min, x, 7);
		var range = A2($elm$core$List$range, minStart, maxStart);
		return A2(
			$elm$core$List$map,
			$author$project$Chain$Chain(cat),
			range);
	} else {
		return _List_Nil;
	}
};
var $author$project$Updates$addTileChains = F4(
	function (tile, cnts, map, potential) {
		var triple = _Utils_Tuple3(cnts, map, potential);
		var chains = $author$project$Chain$potentialChains(tile);
		return A3(
			$elm$core$List$foldl,
			$author$project$Updates$addSingleChain(tile),
			triple,
			chains);
	});
...
var $author$project$KeyCounts$toList = function (_v0) {
	var invkey = _v0.b;
	var d = _v0.c;
	var counts = $elm$core$Dict$toList(d);
	return A2(
		$elm$core$List$map,
		function (t) {
			return _Utils_Tuple2(
...
var $author$project$Main$chiRcv = function (model) {
	...
	if (!_v0.$) {
		var game = _v0.a;
		var prevAction = $elm$core$Maybe$Just(2);
		var newState = 1;
		var newGame = _Utils_update(
			game,
...
var $author$project$Server$Kong = 1;
var $author$project$Server$MustDraw = 4;
var $author$project$Server$Pung = 0;
var $author$project$Server$SelectDrop = 0;
var $author$project$Chain$expandChain = function (_v0) {
	var cat = _v0.a;
	var x = _v0.b;
	var nums = A2($elm$core$List$range, x, x + 2);
	return A2(
		$elm$core$List$map,
		$author$project$Tile$Numeric(cat),
		nums);
};
var $author$project$KeyCounts$decrease_n = F2(
	function (n, maybe) {
		if (maybe.$ === 1) {
			return $elm$core$Maybe$Nothing;
		} else {
			var x = maybe.a;
			return (_Utils_cmp(x, n) < 1) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(x - n);
		}
	});
var $author$project$KeyCounts$decrease = F3(
	function (val, n, counts) {
		var prevVal = A2($author$project$KeyCounts$get, val, counts);
		var newVal = A2($elm$core$Basics$max, 0, prevVal - n);
		var _v0 = counts;
		var keygen = _v0.a;
		var invkey = _v0.b;
		var d = _v0.c;
...
var $author$project$KeySet$remove = F2(
	function (val, _v0) {
		...
		return A3(
			...
			keygen,
			invkey,
			A2($elm$core$Set$remove, key, s));
	});
var $author$project$Updates$removePungKong = F4(
	function (tile, prev, _new, un) {
		var removed = !_new;
		var potential = (prev >= 3) ? ((_new === 3) ? un.g : ((_new === 2) ? A2(
			$author$project$KeySet$remove,
			$author$project$Combo$Triple(tile),
			un.g) : A2(
			$author$project$KeySet$remove,
...
var $author$project$Updates$chiRemove = F5(
	function (c, prev, _new, canChi, potential) {
		...
		var newChi = A2($author$project$Chain$chiTiles, _new, c);
		var newSize = $author$project$KeySet$size(newChi);
		var newPotential = ((prevSize === 3) && (newSize < 3)) ? A2(
			$author$project$KeySet$remove,
			$author$project$Combo$Chain(c),
			potential) : potential;
		var diff = A2($author$project$KeySet$diff, prevChi, newChi);
		var tiles = $author$project$KeySet$toList(diff);
		return _Utils_Tuple2(
			A3(
				$elm$core$List$foldl,
...
var $author$project$KeySet$isEmpty = function (keys) {
	var _v0 = keys;
	var keygen = _v0.a;
	var invkey = _v0.b;
	return _Utils_eq(
		keys,
		A2($author$project$KeySet$empty, keygen, invkey));
};
var $author$project$ChainMap$removeTileChain = F2(
	function (tile, maybe) {
		if (maybe.$ === 1) {
			return $elm$core$Maybe$Nothing;
		} else {
			var ts = maybe.a;
			var new_ts = A2($author$project$KeySet$remove, tile, ts);
			return $author$project$KeySet$isEmpty(new_ts) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(new_ts);
		}
	});
var $author$project$ChainMap$remove = F3(
	function (t, c, map) {
		var prev_ts = A2($author$project$ChainMap$get, c, map);
		var new_ts = A2($author$project$KeySet$remove, t, prev_ts);
		var key = $author$project$Chain$chainKey(c);
		var _v0 = map;
		var d = _v0;
		var new_map = A3(
...
var $author$project$Updates$removeTileChains = F4(
	function (tile, cnts, map, potential) {
		...
		return A3(
			$elm$core$List$foldl,
			$author$project$Updates$removeSingleChain(tile),
			triple,
			chains);
	});
...
var $author$project$Mahjong$unmatchedMatchCombo = F2(
	function (combo, un) {
		switch (combo.$) {
			case 0:
				var c = combo.a;
				var tiles = $author$project$Chain$expandChain(c);
				return A3(
					$elm$core$List$foldl,
					$author$project$Mahjong$removeTiles_aux(1),
					un,
					tiles);
			case 1:
				var tile = combo.a;
			...
			default:
				var tile = combo.a;
				return A3($author$project$Mahjong$removeTiles_aux, 4, tile, un);
		}
	});
var $author$project$Mahjong$matchCombo = F2(
	function (_v0, combo) {
		var un = _v0.a;
		var _v1 = _v0.b;
		var comboCnt = _v1.a;
...
var $author$project$Mahjong$addCombo = F2(
	function (combo, hand) {
		return A2($author$project$Mahjong$matchCombo, hand, combo);
	});
...
var $author$project$Server$addComboInfo = F3(
	function (player, combo, info) {
...
var $author$project$Chain$keyChain = function (key) {
	return (key <= 7) ? A2($author$project$Chain$Chain, 0, key) : ((key <= 14) ? A2($author$project$Chain$Chain, 1, key - 7) : A2($author$project$Chain$Chain, 2, key - 14));
};
var $author$project$Chain$totChains = 21;
var $author$project$Tile$uniqueTiles = 34;
var $author$project$Combo$keyCombo = function (key) {
	return (_Utils_cmp(key, $author$project$Chain$totChains) < 1) ? $author$project$Combo$Chain(
		$author$project$Chain$keyChain(key)) : ((_Utils_cmp(key, $author$project$Chain$totChains + $author$project$Tile$uniqueTiles) < 1) ? $author$project$Combo$Double(
		$author$project$Tile$keyTile(key - $author$project$Chain$totChains)) : ((_Utils_cmp(key, $author$project$Chain$totChains + (2 * $author$project$Tile$uniqueTiles)) < 1) ? $author$project$Combo$Triple(
		...
		if (!_v0.$) {
			...
			var _v1 = function () {
				switch (combo.$) {
					...
					default:
						return _Utils_Tuple2(0, $elm$core$Maybe$Nothing);
				}
			}();
			var newState = _v1.a;
			var newAction = _v1.b;
...
var $author$project$Server$Draw = 4;
var $author$project$Server$Over = 5;
var $author$project$Server$addTileInfo = F2(
...
var $author$project$Combo$comboKey = function (combo) {
	switch (combo.$) {
		case 0:
			var c = combo.a;
			return $author$project$Chain$chainKey(c);
		case 1:
			var tile = combo.a;
			return $author$project$Tile$tileKey(tile) + $author$project$Chain$totChains;
		case 2:
			var tile = combo.a;
			return ($author$project$Tile$tileKey(tile) + $author$project$Chain$totChains) + $author$project$Tile$uniqueTiles;
		default:
			var tile = combo.a;
		...
		while (true) {
			if (!combos.b) {
				...
				if (!n) {
					...
					var dig = $author$project$Combo$comboKey(combo) * A2($elm$core$Basics$pow, $author$project$Combo$totCombos, n - 1);
					var $temp$acc = acc + dig,
						$temp$n = n - 1,
						$temp$combos = rest;
					acc = $temp$acc;
					n = $temp$n;
					combos = $temp$combos;
					continue comboCountsKey_tr;
				}
			}
		}
	});
var $author$project$Combo$comboCountsKey = function (comboCounts) {
	var combos = A2(
		$elm$core$List$concatMap,
		function (pair) {
			return A2($elm$core$List$repeat, pair.b, pair.a);
		},
		$author$project$KeyCounts$toList(comboCounts));
	return A3($author$project$Combo$comboCountsKey_tr, 0, 5, combos);
};
var $author$project$KeyCounts$empty = F2(
	function (keygen, invkey) {
		return A3($author$project$KeyCounts$Count, keygen, invkey, $elm$core$Dict$empty);
	});
var $author$project$Combo$emptyComboCounts = A2($author$project$KeyCounts$empty, $author$project$Combo$comboKey, $author$project$Combo$keyCombo);
var $author$project$Combo$keyComboCounts = function (key) {
	return $author$project$Combo$emptyComboCounts;
};
var $author$project$Combo$emptyComboCountsSet = A2($author$project$KeySet$empty, $author$project$Combo$comboCountsKey, $author$project$Combo$keyComboCounts);
...
var $author$project$KeySet$filter = F2(
	function (f, _v0) {
		var keygen = _v0.a;
		var invkey = _v0.b;
		var s1 = _v0.c;
...
var $author$project$Combo$filterOutDouble = function (combo) {
	if (combo.$ === 1) {
		return false;
	} else {
		return true;
...
var $author$project$TileMap$insert = F3(
	function (tile, counts, _v0) {
		var d = _v0;
		var key = $author$project$Tile$tileKey(tile);
		var new_d = A3($elm$core$Dict$insert, key, counts, d);
		return new_d;
	});
...
var $author$project$KeySet$member = F2(
	function (val, _v0) {
		var keygen = _v0.a;
		var s = _v0.c;
		var key = keygen(val);
		return A2($elm$core$Set$member, key, s);
	});
var $elm$core$Basics$not = _Basics_not;
var $author$project$KeySet$fromList = F3(
	function (keygen, invkey, vs) {
		var keys = A2($elm$core$List$map, keygen, vs);
		return A3(
			$author$project$KeySet$KeySet,
			keygen,
			invkey,
			$elm$core$Set$fromList(keys));
	});
var $author$project$Chain$chainSetFromList = function (cs) {
	return A3($author$project$KeySet$fromList, $author$project$Chain$chainKey, $author$project$Chain$keyChain, cs);
};
...
var $author$project$KeySet$intersect = F2(
	function (_v0, _v1) {
		var keygen = _v0.a;
		var invkey = _v0.b;
		var s1 = _v0.c;
		...
		return A3(
			...
			keygen,
			invkey,
			A2($elm$core$Set$intersect, s1, s2));
	});
var $author$project$Chain$missingTile = F3(
	function (t1, t2, _v0) {
		var cat = _v0.a;
		var x = _v0.b;
		var _v1 = _Utils_Tuple2(t1, t2);
		if ((!_v1.a.$) && (!_v1.b.$)) {
			var _v2 = _v1.a;
			var y = _v2.b;
			var _v3 = _v1.b;
			...
			var reduced_nums = A2(
				$elm$core$Set$remove,
				z,
				A2($elm$core$Set$remove, y, nums));
			var reduced_list = $elm$core$Set$toList(reduced_nums);
			var head = $elm$core$List$head(reduced_list);
			if (!head.$) {
				var a = head.a;
				return A2($author$project$Tile$Numeric, cat, a);
			} else {
				return t1;
			}
		} else {
...
var $author$project$Chain$potentialChain = F2(
	function (t1, t2) {
		var c2 = $author$project$Chain$chainSetFromList(
			$author$project$Chain$potentialChains(t2));
		var c1 = $author$project$Chain$chainSetFromList(
			$author$project$Chain$potentialChains(t1));
		var chains = $author$project$KeySet$toList(
			A2($author$project$KeySet$intersect, c1, c2));
		var tiles = A2(
			$elm$core$List$map,
			function (c) {
				return _Utils_Tuple2(
					A3($author$project$Chain$missingTile, t1, t2, c),
					c);
			},
			chains);
		return tiles;
	});
var $author$project$Mahjong$getWinning_tr = F2(
	function (hand, _v0) {
		var accSeen = _v0.a;
		var accTiles = _v0.b;
		var accWin = _v0.c;
		...
		if ($author$project$KeySet$isEmpty(combos)) {
						...
						if ((un.j === 2) && un.F) {
							...
							if ((tiles.b && tiles.b.b) && (!tiles.b.b.b)) {
								...
								if (_Utils_eq(t1, t2)) {
									...
									var winTiles = A2($author$project$Chain$potentialChain, t1, t2);
									var newMap = A3(
										$elm$core$List$foldl,
										F2(
											function (pair, map) {
												return A3(
													$author$project$TileMap$insert,
													pair.a,
													A2(
														$author$project$KeyCounts$insert,
										...
										accTiles,
										winTiles);
									return _Utils_Tuple3(newAccSeen, newMap, accWin);
								}
							} else {
								return _Utils_Tuple3(newAccSeen, accTiles, accWin);
							}
			...
			var comboList = $author$project$KeySet$toList(combos);
			var newHands = A2(
				$elm$core$List$map,
				$author$project$Mahjong$matchCombo(hand),
				comboList);
			var filterHands = A2(
				...
				function (h) {
					...
					var _v7 = matched;
					var cc = _v7.a;
					return !A2($author$project$KeySet$member, cc, accSeen);
				},
				newHands);
			return A3(
				$elm$core$List$foldl,
				$author$project$Mahjong$getWinning_tr,
				_Utils_Tuple3(newAccSeen, accTiles, accWin),
				filterHands);
		}
	});
var $author$project$Mahjong$getWinning = function (hand) {
	return A2(
		$author$project$Mahjong$getWinning_tr,
		hand,
		_Utils_Tuple3($author$project$Combo$emptyComboCountsSet, $author$project$TileMap$empty, $elm$core$Maybe$Nothing));
};
var $author$project$Mahjong$updateWinning = function (hand) {
	var _v0 = $author$project$Mahjong$getWinning(hand);
	var canWin = _v0.b;
	var winnable = _v0.c;
	var _v1 = hand;
	var un = _v1.a;
...
var $author$project$Mahjong$dropTile = F2(
	function (tile, hand) {
		return $author$project$Mahjong$updateWinning(
			A3($author$project$Mahjong$removeTiles, 1, tile, hand));
	});
var $author$project$Server$dropTileInfo = F2(
	function (player, info) {
		var maybeCurrInfo = A2($elm$core$Array$get, player, info);
		if (!maybeCurrInfo.$) {
			var currInfo = maybeCurrInfo.a;
...
var $author$project$Main$dropRcv = F2(
	function (num, model) {
		var _v0 = model.a;
		if (!_v0.$) {
			var game = _v0.a;
	...
	function (hand, nums) {
		...
		while (true) {
			if (!nums.b) {
				...
				var x = nums.a;
				var rest = nums.b;
				var tile = $author$project$Tile$shuffleConvert(x);
				var $temp$hand = A2($author$project$Mahjong$addTile, tile, hand),
					$temp$nums = rest;
				hand = $temp$hand;
				nums = $temp$nums;
				continue getHand_r;
...
var $author$project$Mahjong$initMatched = _Utils_Tuple2($author$project$Combo$emptyComboCounts, 0);
...
var $author$project$Mahjong$getHand = function (nums) {
	return $author$project$Mahjong$updateWinning(
		A2($author$project$Mahjong$getHand_r, $author$project$Mahjong$initHand, nums));
};
var $author$project$Mahjong$handSize = 13;
...
var $author$project$Mahjong$totTiles = $author$project$Tile$uniqueTiles * 4;
var $author$project$Server$initGame = F3(
	function (player, nums, starting) {
...
var $author$project$Server$handsInfo = F2(
	function (handrets, info) {
		var handsInfo_tr = F3(
			function (idx, hands, info_acc) {
				handsInfo_tr:
				while (true) {
					if (idx === 4) {
						return info_acc;
						...
						if (!hands.b) {
							...
							var $temp$idx = idx + 1,
								$temp$hands = rest,
								$temp$info_acc = newArr;
							idx = $temp$idx;
							hands = $temp$hands;
							info_acc = $temp$info_acc;
							continue handsInfo_tr;
						}
					}
				}
			});
		return A3(handsInfo_tr, 0, handrets, info);
	});
var $author$project$Main$handsRcv = F2(
	function (hands, model) {
		var _v0 = model.a;
		if (!_v0.$) {
			var game = _v0.a;
...
var $author$project$TileMap$get = F2(
	function (t, _v0) {
		var d = _v0;
		var key = $author$project$Tile$tileKey(t);
		return A2($elm$core$Dict$get, key, d);
	});
var $author$project$Mahjong$canHu = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var m = _v0.b;
...
var $author$project$Mahjong$canHidKong = function (_v0) {
	var un = _v0.a;
	return !_Utils_eq(un.h, $author$project$Combo$emptyComboSet);
};
var $author$project$Mahjong$canKong = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var m = _v0.b;
...
var $author$project$Server$SelectKong = 2;
var $author$project$Main$kongRcv = function (model) {
	var _v0 = model.a;
	if (!_v0.$) {
		var game = _v0.a;
...
var $author$project$Mahjong$canPung = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var m = _v0.b;
...
var $author$project$Mahjong$smallKongHand = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var _v1 = _v0.b;
		var combos = _v1.a;
		var cnt = _v1.b;
		var toRemove = $author$project$Combo$Triple(tile);
		var toAdd = $author$project$Combo$Quad(tile);
		var newUn = A3($author$project$Mahjong$removeTiles_aux, 1, tile, un);
		var newCombos = A2(
			$author$project$KeyCounts$insert,
			toAdd,
		...
		return A2(
			...
			newUn,
			_Utils_Tuple2(newCombos, cnt));
	});
var $author$project$Server$upgradeTriple_tr = F3(
	function (acc, tile, combos) {
		upgradeTriple_tr:
		while (true) {
			if (!combos.b) {
				return acc;
				...
				if (_Utils_eq(
					...
					var $temp$acc = A2($elm$core$List$cons, combo, acc),
						$temp$tile = tile,
						$temp$combos = rest;
					acc = $temp$acc;
					tile = $temp$tile;
					combos = $temp$combos;
					continue upgradeTriple_tr;
				}
			}
		}
	});
var $author$project$Server$upgradeTriple = F2(
	function (tile, combos) {
		return A3($author$project$Server$upgradeTriple_tr, _List_Nil, tile, combos);
	});
var $author$project$Server$smallKongInfo = F3(
	function (player, tile, info) {
		var maybeCurrInfo = A2($elm$core$Array$get, player, info);
		if (!maybeCurrInfo.$) {
			var currInfo = maybeCurrInfo.a;
...
var $author$project$Main$smallKongRcv = F2(
	function (num, model) {
		var _v0 = model.a;
		if (!_v0.$) {
			var game = _v0.a;
...
var $author$project$Mahjong$canTileHidKong = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var check = $author$project$Combo$Quad(tile);
		return A2($author$project$KeySet$member, check, un.h);
	});
...
var $author$project$Chain$tileToChain = function (tile) {
	if (!tile.$) {
		var c = tile.a;
		var x = tile.b;
		return (x > 7) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			A2($author$project$Chain$Chain, c, x));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Mahjong$confirmChi = F3(
	function (firstTile, chiTile, _v0) {
		var un = _v0.a;
		var _v1 = $author$project$Chain$tileToChain(firstTile);
		if (_v1.$ === 1) {
			return -1;
		} else {
			var chain = _v1.a;
			var tiles = $author$project$Chain$expandChain(chain);
			var key = $author$project$Combo$comboKey(
				$author$project$Combo$Chain(chain));
			return A2(
				$author$project$KeySet$member,
				$author$project$Combo$Chain(chain),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var dealRet = msg.a;
				return A2($author$project$Main$getDeal, dealRet, model);
			case 4:
				var receive = msg.a;
				switch (receive.$) {
					case 0:
						var num = receive.a;
						return A2($author$project$Main$dropRcv, num, model);
					case 1:
						var num = receive.a;
						return A2($author$project$Main$drewRcv, num, model);
					case 2:
						var key = receive.a;
					...
					case 6:
						var num = receive.a;
						return A2($author$project$Main$smallKongRcv, num, model);
					case 8:
						var lobbies = receive.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{Z: lobbies}),
					...
					case 9:
						...
						return _Utils_Tuple2(
							...
							$elm$core$Platform$Cmd$none);
					default:
						var errMsg = 'Player disconnected. Game abandoned.';
			...
			case 3:
				var tile = msg.a;
				return A2($author$project$Main$tileClick, tile, model);
			case 5:
				switch (msg.a) {
					case 0:
						var _v3 = msg.a;
						return $author$project$Main$pungButton(model);
					case 2:
						var _v4 = msg.a;
						return $author$project$Main$chiButton(model);
					case 4:
						var _v5 = msg.a;
						return $author$project$Main$drawButton(model);
					case 1:
						var _v6 = msg.a;
						return $author$project$Main$kongButton(model);
					case 3:
						var _v7 = msg.a;
						return $author$project$Main$huButton(model);
					case 6:
						var _v8 = msg.a;
						return _Utils_Tuple2(
							model,
...
var $author$project$Display$returnButton = function () {
	var txt = 'Click to return to home page.';
	var button = A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Server$Reset(true))
			]),
		_List_fromArray(
			[
...
var $author$project$Display$inSession = function () {
	var txt = $elm$html$Html$text('Game already in session.');
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[txt, $author$project$Display$returnButton]));
}();
...
var $author$project$Server$JoinGame = function (a) {
	return {$: 7, a: a};
};
...
var $author$project$Lobby$makeLobby = function (lobby) {
	...
	var players_div = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('lobby_players')
			]),
		_List_fromArray(
			[
	...
	var id_div = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('lobby_id')
			]),
		_List_fromArray(
			[
...
var $author$project$Server$CreateGame = {$: 6};
var $author$project$Lobby$pad = function (lobbyStatus) {
	var msg = function () {
		if (lobbyStatus.$ === 1) {
			return _List_Nil;
		} else {
			var str = lobbyStatus.a;
			return _List_fromArray(
				[
	...
	var lobby_status = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('lobby_status')
			]),
		msg);
	var button = A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick($author$project$Server$CreateGame)
			]),
		_List_fromArray(
			[
	...
	var new_game = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('new_game')
			]),
		_List_fromArray(
			[button]));
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('pad')
			]),
		_List_fromArray(
			[new_game, lobby_status]));
};
var $author$project$Lobby$makeLobbies = F2(
	function (lobbies, lobbyStatus) {
		var lobbyDivs = A2($elm$core$List$map, $author$project$Lobby$makeLobby, lobbies);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('lobbies')
				]),
			A2(
				$elm$core$List$cons,
				$author$project$Lobby$pad(lobbyStatus),
				lobbyDivs));
	});
var $author$project$Lobby$lobbyPage = F2(
	function (lobbies, lobbyStatus) {
		var title = A2(
			$elm$html$Html$h1,
			_List_Nil,
		...
		var caption = A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Click to join a game')
				]));
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					title,
					caption,
					A2($author$project$Lobby$makeLobbies, lobbies, lobbyStatus)
				]));
	});
var $author$project$Display$Bot = 3;
var $author$project$Display$Up = function (a) {
	return {$: 1, a: a};
};
var $author$project$Combo$comboSetFromList = function (combos) {
	return A3($author$project$KeySet$fromList, $author$project$Combo$comboKey, $author$project$Combo$keyCombo, combos);
};
var $author$project$Tile$tileSetFromList = function (ts) {
	return A3($author$project$KeySet$fromList, $author$project$Tile$tileKey, $author$project$Tile$keyTile, ts);
};
var $author$project$Mahjong$chiLowest = F2(
	function (tile, _v0) {
		var un = _v0.a;
		var m = _v0.b;
		var chains = $author$project$Combo$comboSetFromList(
			A2(
				$elm$core$List$map,
				$author$project$Combo$Chain,
				$author$project$Chain$potentialChains(tile)));
		var valid = $author$project$KeySet$toList(
			A2($author$project$KeySet$intersect, chains, un.g));
		var tiles = A2(
			$elm$core$List$map,
			function (combo) {
				if (!combo.$) {
					var c = combo.a;
					var ts = $author$project$Chain$expandChain(c);
					var head = $elm$core$List$head(ts);
					if (!head.$) {
						var t = head.a;
						return t;
					} else {
			...
			valid);
		return $author$project$Tile$tileSetFromList(tiles);
	});
var $author$project$Server$TileAction = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Display$displayTile = F4(
	function (side, t, clickable, highlight) {
		var tileStr = function () {
			if (!t.$) {
				return '0';
			} else {
				var tile = t.a;
		...
		var baseStr = 'static/tiles/' + tileStr;
		switch (side) {
			case 0:
				var loc = $elm$html$Html$Attributes$src(baseStr + '.png');
				...
				return A2(
					$elm$html$Html$img,
					A2($elm$core$List$cons, loc, classes),
					_List_Nil);
			case 1:
				var loc = $elm$html$Html$Attributes$src(baseStr + 'r.png');
				var classes = _List_fromArray(
					[
			...
			case 3:
				var loc = $elm$html$Html$Attributes$src(baseStr + '.png');
				var classes = highlight ? _List_fromArray(
					[
						$elm$html$Html$Attributes$class('highlight'),
						$elm$html$Html$Attributes$class('bot'),
						$elm$html$Html$Attributes$class('tile')
					]) : _List_fromArray(
					[
						$elm$html$Html$Attributes$class('bot'),
				...
				if (clickable) {
					...
					var selectable = $elm$html$Html$Attributes$class('selectable');
					var click = $elm$html$Html$Events$onClick(
						$author$project$Server$TileAction(tile));
					return A2(
						$elm$html$Html$img,
						A2(
							$elm$core$List$cons,
							...
							A2(
								$elm$core$List$cons,
								click,
								A2($elm$core$List$cons, selectable, classes))),
						_List_Nil);
				} else {
					return A2(
						$elm$html$Html$img,
...
var $author$project$Display$displayChain = F2(
	function (side, chain) {
		var tiles = $author$project$Chain$expandChain(chain);
		return A2(
			$elm$core$List$map,
			function (t) {
				return A4(
					$author$project$Display$displayTile,
					side,
					$author$project$Display$Up(t),
					false,
					false);
			},
			tiles);
	});
var $author$project$Display$displayCombo = F2(
	function (side, combo) {
		switch (combo.$) {
			case 0:
				var c = combo.a;
				return A2($author$project$Display$displayChain, side, c);
			case 1:
				var t = combo.a;
				return A2(
...
var $author$project$Display$displayCombos = F2(
	function (side, combos) {
		return A2(
			$elm$core$List$concatMap,
			$author$project$Display$displayCombo(side),
			combos);
	});
var $author$project$Display$divider = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id('divider')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('visible →')
				]))
		]));
var $author$project$Display$find_tr = F3(
	function (acc, tile, tiles) {
		find_tr:
		while (true) {
			if (!tiles.b) {
				return -1;
...
var $author$project$Display$find = F2(
	function (tile, tiles) {
		return A3($author$project$Display$find_tr, 0, tile, tiles);
	});
var $author$project$Mahjong$getHandCombos = function (_v0) {
	var un = _v0.a;
	var m = _v0.b;
	var comboCount = m.a;
	return A2(
		...
		$author$project$KeyCounts$toList(comboCount));
};
var $author$project$Mahjong$getHidKongs = function (_v0) {
	var un = _v0.a;
	var m = _v0.b;
	var combos = $author$project$KeySet$toList(un.h);
	var tiles = A2(
		$elm$core$List$map,
		function (combo) {
			if (combo.$ === 3) {
...
var $author$project$Mahjong$getSortedTiles = function (_v0) {
	var un = _v0.a;
	var m = _v0.b;
...
var $author$project$Display$displayHand = function (game) {
	...
	switch (_v0) {
		...
		case 0:
			...
			var clickable = _Utils_eq(game.m, game.f);
			var hidden = A2(
...
var $author$project$Display$botRow = function (game) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		$author$project$Display$displayHand(game));
};
var $author$project$Display$getTag = F2(
	function (player, side) {
		...
		var idx = A2($elm$core$Basics$modBy, 4, player + inc);
		var txt = (side !== 3) ? ('Player ' + $elm$core$String$fromInt(idx + 1)) : ('You are Player ' + $elm$core$String$fromInt(idx + 1));
		return $elm$html$Html$text(txt);
	});
var $author$project$Display$botTag = function (player) {
	var tag = A2($author$project$Display$getTag, player, 3);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Display$actionTxt = function (game) {
	...
	switch (_v0) {
		...
		case 1:
			return (!_Utils_eq(game.m, game.f)) ? $elm$core$Maybe$Just('Waiting for ' + (player + ' to reveal Chi.')) : $elm$core$Maybe$Just('Select the lowest tile of your Chi to reveal.');
		case 2:
			return (!_Utils_eq(game.m, game.f)) ? $elm$core$Maybe$Just('Waiting for ' + (player + ' to reveal Kong.')) : $elm$core$Maybe$Just('Select your concealed Kong to reveal.');
		case 3:
			return (!_Utils_eq(game.m, game.f)) ? $elm$core$Maybe$Just(player + '\'s Turn.') : $elm$core$Maybe$Just('Your turn.');
		case 4:
			return (!_Utils_eq(game.m, game.f)) ? $elm$core$Maybe$Just('Waiting for ' + (player + ' to draw a tile.')) : $elm$core$Maybe$Just('Now draw another tile.');
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Server$Restart = 6;
var $author$project$Server$Button = function (a) {
	return {$: 5, a: a};
};
var $author$project$Display$makeButton = function (maybePair) {
	if (!maybePair.$) {
		var _v1 = maybePair.a;
		var txt = _v1.a;
		var action = _v1.b;
		var button = A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick(
					$author$project$Server$Button(action))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(txt)
...
var $author$project$Display$buttons = function (game) {
	var pairs = (game.P === 5) ? _List_fromArray(
		...
		[
			...
			_Utils_Tuple2('Chi', 2)),
			$elm$core$Maybe$Just(
			_Utils_Tuple2('Pung', 0)),
			$elm$core$Maybe$Just(
			_Utils_Tuple2('Draw', 4)),
			$elm$core$Maybe$Just(
			_Utils_Tuple2('Kong', 1)),
			$elm$core$Maybe$Just(
			_Utils_Tuple2('Hu', 3))
		]);
	var buttonList = A2($elm$core$List$map, $author$project$Display$makeButton, pairs);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Display$Center = 4;
var $author$project$Display$dropTile = function (game) {
	var remain = A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('remaining')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(
			...
			return _Utils_Tuple2(
				_List_fromArray(
					[
						...
						$author$project$Display$displayTile,
						4,
						$author$project$Display$Up(drawn),
						false,
						false)
					]),
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('recent')
						]),
					_List_fromArray(
						[
				...
				return _Utils_Tuple2(
					_List_fromArray(
						[
							...
							$author$project$Display$displayTile,
							4,
							$author$project$Display$Up(dropped),
							false,
							false)
						]),
					A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Recently Dropped:')
							])));
			} else {
				return _Utils_Tuple2(
					_List_Nil,
	...
	var imageWrap = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('drop_inner')
			]),
		img);
	var left = A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('next_drop')
			]),
		_List_fromArray(
			[recent, remain]));
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('drop_wrap')
			]),
		_List_fromArray(
			[left, imageWrap]));
};
...
var $author$project$Display$prevTxt = function (game) {
	...
	if (_v0.$ === 1) {
		...
		return $elm$core$Maybe$Just(
			_Utils_ap(
				txt,
				_Utils_ap(player, end)));
	} else {
		var action = _v0.a;
		switch (action) {
			case 0:
				return $elm$core$Maybe$Just(player + ' Pung\'ed');
			case 1:
				return $elm$core$Maybe$Just(player + ' Kong\'ed');
			case 2:
				return $elm$core$Maybe$Just(player + ' Chi\'ed');
			case 3:
			...
			case 5:
				...
				return $elm$core$Maybe$Just(prevPlayer + ' dropped a tile.');
			default:
				return $elm$core$Maybe$Nothing;
		}
	}
};
var $author$project$Display$status = F3(
	function (won, err, txt) {
		var inner = function () {
			if (!txt.$) {
				var str = txt.a;
				return _List_fromArray(
		...
		var classes2 = err ? A2(
			...
			classes1) : classes1;
		return A2($elm$html$Html$div, classes2, inner);
	});
var $author$project$Display$middle = F2(
	function (game, wonSide) {
		var won = _Utils_eq(
			wonSide,
			$elm$core$Maybe$Just(3));
		var prev = A3(
			$author$project$Display$status,
			won,
			false,
			$author$project$Display$prevTxt(game));
		var errorItem = A3(
			$author$project$Display$status,
			false,
			true,
			$author$project$Display$errorTxt(game));
		var action = A3(
			$author$project$Display$status,
			false,
			false,
			$author$project$Display$actionTxt(game));
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					action,
					errorItem,
					$author$project$Display$dropTile(game),
					$author$project$Display$buttons(game)
				]));
	});
var $author$project$Display$Top = 0;
var $author$project$Display$Down = {$: 0};
var $author$project$Display$displayInfo = F3(
	function (player, side, info) {
		var inc = function () {
			switch (side) {
				case 2:
					return 1;
		...
		var idx = A2($elm$core$Basics$modBy, 4, player + inc);
		var pair = A2($elm$core$Array$get, idx, info);
		if (!pair.$) {
			var tileInfo = pair.a;
			var tiles = A2(
				$elm$core$List$map,
...
var $author$project$Display$topRow = F2(
	function (player, info) {
		var imgs = A3($author$project$Display$displayInfo, player, 0, info);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('top_row')
				]),
			imgs);
	});
var $author$project$Display$topTag = F2(
	function (game, wonSide) {
		var tag = A2($author$project$Display$getTag, game.f, 0);
		var sideClass = $elm$html$Html$Attributes$class('player');
		var classes = _Utils_eq(
			wonSide,
...
var $author$project$Display$center = F2(
	function (game, wonSide) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('center')
				]),
			_List_fromArray(
				[
					topTiles,
					topPlayer,
					A2($author$project$Display$middle, game, wonSide)
				]));
	});
var $author$project$Display$Left = 1;
var $author$project$Display$leftRow = F2(
	function (player, info) {
		var imgs = A3($author$project$Display$displayInfo, player, 1, info);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('side_row')
				]),
			imgs);
	});
var $author$project$Display$leftTag = F2(
	function (game, wonSide) {
		var tag = A2($author$project$Display$getTag, game.f, 1);
		var sideClass = $elm$html$Html$Attributes$class('side_player');
		var classes = _Utils_eq(
			wonSide,
...
var $author$project$Display$Right = 2;
var $author$project$Display$rightRow = F2(
	function (player, info) {
		var imgs = A3($author$project$Display$displayInfo, player, 2, info);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Display$rightTag = F2(
	function (game, wonSide) {
		var tag = A2($author$project$Display$getTag, game.f, 2);
		var defClasses = _List_fromArray(
			[
				$elm$html$Html$Attributes$class('side_player'),
				$elm$html$Html$Attributes$class('flip')
			]);
		var classes = _Utils_eq(
			wonSide,
			$elm$core$Maybe$Just(2)) ? A2(
			$elm$core$List$cons,
			$elm$html$Html$Attributes$class('winner'),
...
var $author$project$Display$others = F2(
	function (game, wonSide) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('others')
				]),
			_List_fromArray(
				[
					A2($author$project$Display$leftRow, player, info),
					A2($author$project$Display$leftTag, game, wonSide),
					A2($author$project$Display$center, game, wonSide),
					A2($author$project$Display$rightTag, game, wonSide),
					A2($author$project$Display$rightRow, player, info)
				]));
	});
var $author$project$Display$winningSide = function (game) {
	if ((game.P === 5) && _Utils_eq(
		...
		return $elm$core$Maybe$Just(winSide);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Display$page = function (game) {
	var wonSide = $author$project$Display$winningSide(game);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				A2($author$project$Display$others, game, wonSide),
				$author$project$Display$botTag(game.f),
				$author$project$Display$botRow(game)
			]));
};
var $author$project$Display$waiting = function () {
	var txt = $elm$html$Html$text('Waiting for more players.');
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	...
	if (_v0.$ === 1) {
		...
		var x = _v0.a;
		if (x < 0) {
			return $author$project$Display$inSession;
		} else {
			var _v1 = model.a;
			if (_v1.$ === 1) {
				return $author$project$Display$waiting;
			} else {
				var game = _v1.a;
				return $author$project$Display$page(game);
			}
		}
	}
};
